...
> ● **C++知识**
> 学习C++基础知识，学习标准库STL，boost,
> 学习C++设计模式，设计理念
> 学习开发平台：Linux，IDE，代码管理，代码调试，代码测试，代码注释等公交


> ● **标准化软件开发**
> 同学们需要严格按照软件开发流程完成软件从需求，到设计，到架构，到数据，到功能，到函数，到测试，到上线全流程
...
2、Gitee仓库地址： [https://gitee.com/oscc-project/iTraining](https://gitee.com/oscc-project/iTraining)
