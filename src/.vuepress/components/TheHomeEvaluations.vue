...
<script setup>
    ...
    const evaluationsItemList = ref([{
        ...
        text: "Taichi在设计上非常质朴。仅需少量代码，就可以实现炫酷的视觉效果和复杂的功能，对我的<span class='evaluations-highlight'>科研工作帮助极大</span>。",
        author: "徐浩",
        identity: "香港科技大学计算机工程专业博士生",
        style: ""
    }, {
        text: "以往教学需要基于C++框架，脚手架代码很多，不管是助教出作业还是学生完成作业都有些束手束脚。用了Taichi以后，<span class='evaluations-highlight'>生产力</span>有了较大<span class='evaluations-highlight'>提升</span>，可以做一些更复杂的算法。Taichi的<span class='evaluations-highlight'>自动微分</span>功能也免去了同学们导数“怎么算也算不对”的难题。",
        author: "唐经纬",
